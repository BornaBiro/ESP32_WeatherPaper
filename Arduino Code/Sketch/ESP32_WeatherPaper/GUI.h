...
class GUI
{
    ...
    void drawMainScreen(struct sensorData *_sensor, struct currentWeatherHandle *_current, struct forecastListHandle *_forecastList, struct forecastDisplayHandle *_displayForecast, struct oneCallApiHandle *_one, struct measruementHandle *_d1, struct tm *_time);
    ...
    void drawOutdoorData(communication *_comm, time_t _epoch, uint32_t _dayOffset, uint16_t *_dataOffset, uint8_t _graph, uint8_t _fw = 0);
    void drawIndoorData(communication *_comm, time_t _epoch, uint32_t _dayOffset, uint16_t *_dataOffset, uint8_t _graph, uint8_t _fw = 0);
